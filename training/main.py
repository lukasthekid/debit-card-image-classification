from model.network import CNN_v1, MobileNetV2_debit_card
...
if __name__ == "__main__":
    ...
    #cnn.save_model("model/cnn.keras")
    mobile_net.save_model("model/mobile_net_debit.keras")
    mobile_net.store_misclassified("model/misclassified")
